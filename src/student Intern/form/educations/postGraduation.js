...
export default class PostGraduation extends React.Component {
    constructor() {
        super();
                    ...
                    <div>
                                ...
                                <form className="form-group">
                                    ...
                                    <div style={{ padding: "10px", float: "right", display: "flex" }}>
                                        <button className="btn btnedit" style={{ borderRadius: "15px" }}
                                            onClick={(e) => { this.submit(e) }} align="right">Add Post Graduation</button>
                            &nbsp;&nbsp;
                            <button className="btn btnedit"
                                            onClick={() => { this.handleCloseModal() }}>Cancel</button>
                                    </div>
                        ...
                        {this.state.buttonShow ?
                            <div className="row" >
                                ...
                                <button className="btn btns" onClick={() => { this.show() }}>+Add Post Graduation</button>
