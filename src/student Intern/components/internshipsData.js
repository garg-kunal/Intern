...
class InternshipsData extends React.Component {
  ...
  saveInfo (e) {
    ...
    this.setState(
      ...
      () => {
        ...
        axios
          .post('/api/accounts/student/loc_preference', data, headers)
          .then(res => {
  ...
  render () {
    return (
      <div
        className='container-fluid  main-box-location'
        style={{ padding: '0' }}
      >
        <form className='dataForm form-group '>
          <h5>
            Location Preferences <p className='text-right step1 pr-2'>2/3 </p>
          </h5>
          <input
            type='text'
            name='domain1'
          ...
          <div className='row'>
            <div className='col-md-1 pt-1 col-lg-1 col-2 text-center'>
              <input
                ...
                value='full time'
                onClick={e => {
                  this.checkInternshipType(e)
                }}
              />
            </div>
            <div className='col-md-4 col-lg-4 col-10 '>
              <label className='roleLabel' for='full'>
                {' '}
          ...
          <div className='row'>
            ...
            <div className='col-md-4 col-lg-4 col-10'>
              <label className='roleLabel' for='part'>
                {' '}
          ...
          <div className='row'>
            ...
            <div className='col-md-4 col-lg-4 col-10 '>
              <label className='roleLabel' for='both'>
                {' '}
                Both
              </label>
            </div>
