            ...
            <div className="stipendType container-fluid">
                <div className="availableProfiles stipend">
                    <label className="col-12 col-sm-6">
                        <input type="radio" className="" style={{ height: "14px" }} name="stipend" value="Paid" onChange={this.stipendType} />
                        Paid
                    </label>
                    <label className="col-12 col-sm-6">
                        <input type="radio" className="" style={{ height: "14px" }} name="stipend" value="Performance Based" onChange={this.stipendType} />
                        Performance Based
                    </label>

                    <label className="col-12 col-sm-6">
                        <input type="radio" className="" style={{ height: "14px" }} name="stipend" value="Negotiable" onChange={this.stipendType} />
                        Negotiable
                    </label>
                    <label className="col-12 col-sm-6">
